...
consvar_t cv_soundvolume = CVAR_INIT ("soundvolume", "16", CV_SAVE | APK_CV_SLIDER_SAFE, soundvolume_cons_t, NULL);
consvar_t cv_digmusicvolume = CVAR_INIT ("digmusicvolume", "16", CV_SAVE | APK_CV_SLIDER_SAFE, soundvolume_cons_t, NULL);
consvar_t cv_midimusicvolume = CVAR_INIT ("midimusicvolume", "16", CV_SAVE | APK_CV_SLIDER_SAFE, soundvolume_cons_t, NULL);
